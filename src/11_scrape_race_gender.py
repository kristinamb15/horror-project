...
characters = pd.read_csv(path.join(raw_data, '10_horror_characters_with_deaths.csv'), index_col=[0,1])
...
characters.to_csv(path.join(raw_data, '11_horror_characters_with_info.csv'))