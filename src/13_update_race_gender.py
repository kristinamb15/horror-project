...
characters = pd.read_csv(path.join(raw_data, '11_horror_characters_with_info.csv'), index_col=[0,1])
...
# Resave file
characters.to_csv(path.join(raw_data, '13_horror_characters_updated.csv'))
