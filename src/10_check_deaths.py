...
# Load dataframe
characters = pd.read_csv(path.join(raw_data, '09_horror_characters_stripped.csv'), index_col=[0,1])
...
characters.to_csv(path.join(raw_data, '10_horror_characters_with_deaths.csv'))